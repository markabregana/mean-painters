...
var AppHome = (function () {
    function AppHome(siteService) {
        var _this = this;
        this.siteService = siteService;
        this.siteService.getHeader().subscribe(function (sites) {
            _this.sites = sites;
        });
        this.siteService.getHome().subscribe(function (home) {
            _this.homeContents = home;
        });
    }
    return AppHome;
}());
